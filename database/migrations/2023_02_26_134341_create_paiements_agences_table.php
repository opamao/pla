...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('paiements_agences', function (Blueprint $table) {
            $table->id('paid');
            $table->integer('montant_pa');
            $table->integer('etat_pa')->default(0)->comment('0 = attente, 1 = payer, 2 = erreur systeme, 3 = annuler, 4 = rembourser');
    ...
    {
        Schema::dropIfExists('paiements_agences');
    }
};

                                            ...
                                            <div class="row mt-4 align-items-center">
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="d-flex justify-content-end">
                                                        ...
                                                        <a href="javascript:void(0);"
                                                           class="btn btn-danger ms-3 text-nowrap">
                                                            SELL
                                        ...
                                        <ul class="nav nav-tabs" role="tablist">
                                            <li class="nav-item">
                                                <a class="nav-link active" data-bs-toggle="tab"
                                                   href="index.html#monthly">
                                                    Monthly
                                                </a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link" data-bs-toggle="tab" href="index.html#Weekly">
                                                    Weekly
                                                </a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link" data-bs-toggle="tab" href="index.html#Today">
                                                    Today
                                                </a>
                                            </li>
                                        </ul>
